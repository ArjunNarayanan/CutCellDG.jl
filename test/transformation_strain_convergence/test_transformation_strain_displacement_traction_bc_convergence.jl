...
function test_displacement_traction_circular_interface()
...
function test_displacement_traction_corner_interface()
    lambda1, mu1 = 100.0, 80.0
    lambda2, mu2 = 80.0, 60.0
    theta0 = -0.067
    stiffness = CutCellDG.HookeStiffness(lambda1, mu1, lambda2, mu2)
...
test_displacement_traction_circular_interface()
test_displacement_traction_corner_interface()
