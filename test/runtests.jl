...
@safetestset "Test Coherent Interface Standard L2 Convergence" begin
    ...
    include("standard_convergence/test_displacement_and_traction_bc_convergence.jl")
...
@safetestset "Test Coherent Interface Transformation Strain L2-norm Displacement Convergence" begin
    include("transformation_strain_convergence/test_transformation_strain_displacement_convergence.jl")
    include("transformation_strain_convergence/test_transformation_strain_displacement_traction_bc_convergence.jl")
    include("transformation_strain_convergence/test_transformation_strain_mixed_bc_convergence.jl")
end
